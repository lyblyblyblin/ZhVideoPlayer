...
import com.zh.zhvideoplayer.BaseActivity;
 ...
 * 视频播放界面
 */
public class PlayerActivity extends BaseActivity implements OnClickListener, OnCompletionListener, OnInfoListener,
    ...
    private void initDatas() {
        ...
        if (videoType == 0) {
            ...
            String videoname = (String) getIntent()
                    .getStringExtra("videoname");
            String videopath = (String) getIntent()
                    .getStringExtra("videopath");
            mVideoRes = new Resources();
            mVideoRes.setTitle(videoname);
            mVideoRes.setDescription("");
            mVideoRes.setLink(videopath);
            Log.e("zh", "本地视频:");
            Log.e("zh", "video.title:" + videoname);
            Log.e("zh", "video.title:" + videopath);
        }
    ...
    public void setVideoURI() {
        if (isPlayLocalVideo == true) {
            ...
            //mVideoView.setVideoURI(Uri.parse("/storage/sdcard1/自制遥控器.flv"));
            mMediaController.getPlayerCenterPlaySwitch().setVisibility(View.GONE);
